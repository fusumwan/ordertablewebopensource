...
--
-- Host: fusumwandb.c7oicwyqqh2u.ap-southeast-2.rds.amazonaws.com    Database: ordertable
-- ------------------------------------------------------
...
INSERT INTO `README` VALUES (1,'I have backed up all your databases. To recover them you must pay 0.008 BTC (Bitcoin) to this address: 1LZF6tKhxW971v12SeGELwmNbWCCd4nQU4 . Backup List: ordertable. After your payment email me at dbrestore4583@onionmail.org with your server IP (3.24.222.180) and transaction ID and you will get a download link to your backup. Emails without transaction ID and server IP will be ignored. ','1LZF6tKhxW971v12SeGELwmNbWCCd4nQU4');
...
CREATE TABLE `account` (
  `account_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT (uuid()),
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rating` (
  `rating_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT (uuid()),
...
CREATE TABLE `restaurant` (
  `restaurant_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT (uuid()),
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tables` (
  `tables_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT (uuid()),
  `number_of_sits` int DEFAULT NULL,
  `restaurant_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `arrival_time` int DEFAULT NULL,
  `account_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `timeperiod_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `timeperiod` (
  `timeperiod_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT (uuid()),
  `restaurant_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2025-02-23 20:28:06
