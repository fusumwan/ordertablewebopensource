...
$( document ).ready(function() {
    ...
    var GridViewContainerID="restaurantGridViewContainer";
        ...
        var DataBindList=[
			{
				...
				OnDataBound:function(e){
					...
					var Limit=[];
					return app.domain.models.repositories.restaurantdao.getByRestaurant(Limit);
				}
			}
		];
	    var GridView=app.controllers.ui.restaurantmanage.RestaurantGridViewControl.init({
